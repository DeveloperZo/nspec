...
```
node c:/Users/awill/Downloads/nSpec-v2/bin/nspec.mjs refine <SPEC_NAME> <STAGE> --feedback "<extracted feedback>"
```

5. After refinement:
   - If downstream stages exist, suggest running `node c:/Users/awill/Downloads/nSpec-v2/bin/nspec.mjs cascade <SPEC_NAME> --from <NEXT_STAGE>` to propagate changes
