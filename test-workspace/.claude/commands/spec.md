...
```
echo '{{CONVERSATION}}' | node c:/Users/awill/Downloads/nSpec-v2/bin/nspec.mjs vibe-to-spec <SPEC_NAME> --cascade
```
...
3. After the command completes successfully:
   ...
   - If the health score is below 80, suggest running `node c:/Users/awill/Downloads/nSpec-v2/bin/nspec.mjs refine <SPEC_NAME> requirements --feedback "..."` to address gaps
